   ...
   <body class="vertical-layout vertical-content-menu 1-column   menu-expanded blank-page blank-page"
                                 ...
                                 <form class="form-horizontal form-simple" action="#" method="post" novalidate>
                                    ...
                                    <div class="tab">
                                       <fieldset class="form-group position-relative mb-0">
                                          <div class="controls">
                                          <label id="me" style="font-size:medium;font-weight:bolder;">PIC Name</label>
                                       ...
                                       <label id="me" style="font-size:medium;font-weight:bolder;">First Name</label>
                                       ...
                                       <fieldset class="form-group position-relative has-icon-left mb-0">
                                       <div class="controls">
                                       <label id="me" style="font-size:medium;font-weight:bolder;">Last Name</label>
                                       ...
                                       <fieldset class="form-group position-relative has-icon-left mb-0">
                                       <label id="me" style="font-size:medium;font-weight:bolder;">Designation</label>
                                       <div class="controls">
                                       ...
                                       <fieldset class="form-group position-relative has-icon-left mb-0">
                                       <label style="font-size:medium;font-weight:bolder;">Department</label>
                                          <div class="controls">
                                       ...
                                       <fieldset class="form-group position-relative has-icon-left mb-0">
                                       <label id="me" style="font-size:medium;font-weight:bolder;">Confirm Password</label>
                                          <div class="controls">
      ...
      <script type="text/javascript">
         ...
         function register_vlnc_finally () {
            ...
            $.post("add-pic.php", php_data, function(data, status) {
               console.log(data, status)
                  if (data.status === "success") {
