                ...
                <h4 class="card-title">Lab ID <?php echo $value['lab_id'];?></h4>
				 ...
				 <?php
				                       ...
				                       <div class="col-lg-3 col-xl-2">
						                          ...
						                          <a data-toggle="collapse" data-parent='<?php echo "#".$value['lab_id'];?>' href='<?php echo "#accordian".$value['lab_id'].$i;?>' aria-expanded="true"
						                        		  aria-controls="accordion51" class="card-title lead white">R<?php echo $i;?></a>
						                      				                        	...
						                      				                        	<?php  if($i<5){?>
				                        	<div class="custom">
				                        	  <img src="images/success.png" height="10" width="23%"/>
				                        	</div>
				                        <?php }  ?>
						               <div id='<?php echo "accordian".$value['lab_id'].$i;?>' role="tabpanel" aria-labelledby='<?php echo $value['lab_id'].$i;?>' class="border-success card-collapse collapse"
				                    	    aria-expanded="true">
				                          <div class="card-content">
				                            <ul class="list-group">
                       ...
                       <?php  if($fvalue['r'.$i]==2){ ?>
				                       ...
				                       <?php  if($i<5){?>
				                        	<div class="custom">
				                        	  <img src="images/warning.png" height="10" width="23%"/>
				                        	</div>
				                        <?php }  ?>

				                        <div id='<?php echo "accordian".$value['lab_id'].$i;?>' role="tabpanel" aria-labelledby='<?php echo $value['lab_id'].$i;?>' class="border-warning card-collapse collapse"
				                        aria-expanded="true">
				                          <div class="card-content">
				                            <ul class="list-group">
				                                <li class="list-group-item">
                ...
                <?php }//R - > Pending For Review ?>
          						...
          						<?php if($fvalue['r'.$i]==0){ ?>
				                        ...
				                        <div class="col-lg-3 col-xl-2">
				                        	...
				                        	<?php  if($i<5){?>
				                        	<div class="custom">
				                        	  <img src="images/dark.png" height="10" width="23%"/>
				                        	</div>
				                        <?php }  ?>
				                        <div id='<?php echo "accordian".$value['lab_id'].$i;?>' role="tabpanel" aria-labelledby='<?php echo $value['lab_id'].$i;?>' class="border-light card-collapse collapse"
				                        aria-expanded="true">
				                          <div class="card-content">
				                            <ul class="list-group">
				                                <li class="list-group-item">
         			  ...
         			  <?php  if($fvalue['r'.$i]==3){ ?>
				                        ...
				                        data-trigger="hover" data-original-title="R0 Form">
				                          ...
				                          aria-controls="accordion51" class="card-title lead white">R<?php echo $i;?></a>
																...
																<?php  if($i<5){?>
				                        	<div class="custom">
				                        	  <img src="images/danger.png" height="10" width="23%"/>
				                        	</div>
				                        <?php }  ?>
				                        <div id='<?php echo "accordian".$value['lab_id'].$i;?>' role="tabpanel" aria-labelledby='<?php echo $value['lab_id'].$i;?>' class="border-warning card-collapse collapse"
				                        aria-expanded="true">
